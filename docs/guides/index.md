# Docs Index (Read First)

Use this file to pick the smallest relevant doc before reading code.
...
## Read order rule
1) Read the smallest relevant doc above.
2) Only open code files if the doc is missing details.
3) If still unclear, read project_structure.md next.

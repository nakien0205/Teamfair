...
- Contribution and fairness
  ...
  - [src/pages/StudentMyContribution.tsx](../../src/pages/StudentMyContribution.tsx) - Full contribution score page with AI-powered analysis. Shows reference score, AI effort summary, anomaly detection, recommendations, score breakdown with weight redistribution when data is missing, evidence summary, and leader feedback. AI analysis loads asynchronously and is cached in Supabase `contribution_ai_analysis` table.
